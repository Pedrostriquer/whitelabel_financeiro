...
export default function RedefinePasswordMobile() {
  ...
  useEffect(() => {
    ...
    if (verificationCode) {
      ...
      setError(
        "Código de verificação não encontrado. Por favor, use o link enviado para seu e-mail."
      );
    }
  }, [searchParams]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(
        "Senha redefinida com sucesso! Você será redirecionado para o aplicativo."
      );

      // ====================================================================
      // ======================== A MUDANÇA ESTÁ AQUI =======================
      // Em vez de usar 'navigate', vamos redirecionar a página para o
      // deep link do seu app.
      setTimeout(() => {
        window.location.href = "gemasbrilhantes://login";
      }, 3000);
      // ====================================================================
    } catch (err) {
